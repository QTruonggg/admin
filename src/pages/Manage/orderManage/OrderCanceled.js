...
export default class OrderCanceled extends Component {
    ...
    callApi = async() => {
        ...
        const sortedOrderList = this.sortOrderByCreateDate(formatList);
       
        this.setState({
            orderCanceledList: sortedOrderList,
            isLoading: false,
            keyWord: null,
            rangePicker: [],
        })
    ...
    sortOrderByCreateDate = (list) => {
        return list.sort((a, b) => moment(b.createDate).valueOf() - moment(a.createDate).valueOf());
    };
    //xem chi tiết
